local library = loadstring(game:HttpGet("https://github.com/alriceeeee/AppleLibraryButBetter/blob/main/main.lua?raw=true"))()

local window = library:init("Titlebar", true, Enum.KeyCode.RightShift, true)

window:Divider("I'm a divider!") -- Divider
